...
public class TestProductControllerIT {
	...
	public void ProductDetailAddItemIntegrationTest() throws Exception {
		...
		String formattedSubtotalInHeader =cartPage.getHtmlElementById("header_formatted_subtotal")	.getTextContent();
		...
		assertThat('('+productCartSubtotal+')').isEqualTo(formattedSubtotalInHeader);  // formatted subtotal in the header
